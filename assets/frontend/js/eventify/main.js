...
// Additional Sections Sliders //
$('[class*="additional-section-slider-"]').each(function() {
  var $carousel = $(this);
  ...
  $carousel.owlCarousel({
    ...
    onInitialized: function() {
      // Move nav inside owl-stage-outer
      var $nav = $carousel.find('.owl-nav');
      var $stageOuter = $carousel.find('.owl-stage-outer');
      if ($nav.length && $stageOuter.length) {
        $stageOuter.append($nav);
      }
    }
  });
});
