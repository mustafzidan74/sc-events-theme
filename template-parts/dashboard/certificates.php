...
jQuery(function ($) {
    ...
    var L = <?php echo $js(array(
        ...
        'emailed'      => sc_t('dashboard_pages.emailed_on', 'Emailed %s'),
        ...
        'email'        => sc_t('dashboard_pages.email_certificate', 'Email the certificate'),
        ...
        'confirmEmail' => sc_t('dashboard_pages.confirm_email_certificates', 'Email %d people a link to download their certificate?'),
        'tooMany'      => sc_t('dashboard_pages.email_max_50', 'Select at most 50 people to email at a time.'),
    ...
    var list = WDList.create({
        ...
        rowMenu: function (c) {
            ...
            return [
                ...
                { label: L.email, icon: ICON.mail, disabled: !live || !c.email, onSelect: function () { askEmail([c.id]); } },
