<?php
/**
 * Dashboard Create Booth Type Page
 *
 * @package sc_events
 */
...
$page_title = sc_t('booths.add_booth_type', 'Add Booth Type');
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <h2><?php echo $t['add_booth_type']; ?></h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo home_url('/event-manager-dashboard/'); ?>"><i class="fa fa-dashboard"></i></a></li>
                        <li class="breadcrumb-item"><a href="<?php echo home_url('/event-manager-dashboard/booth-types'); ?>"><?php echo $t['booth_types']; ?></a></li>
                        <li class="breadcrumb-item active"><?php echo $t['add_booth_type']; ?></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="body">
                        <form id="booth-type-form">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" required placeholder="e.g., Standard Booth, Premium Corner" <?php echo sc_is_rtl() ? 'dir="rtl"' : ''; ?>>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Color</label>
                                        <input type="color" class="form-control" id="color" name="color" value="#3B82F6" style="height: 38px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Describe what's included with this booth type"></textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="total_quantity" name="total_quantity" value="0" min="0">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="size_code" name="size_code">
                                        <option value="3x3">3x3m (9m²)</option>
                                        <option value="3x4">3x4m (12m²)</option>
                                        <option value="4x4">4x4m (16m²)</option>
                                        <option value="6x3">6x3m (18m²)</option>
                                        <option value="6x6">6x6m (36m²)</option>
                                        <option value="9x6">9x6m (54m²)</option>
                                        <option value="9x9">9x9m (81m²)</option>
                                        <option value="12x9">12x9m (108m²)</option>
                                        <option value="custom">Custom</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="width_meters" name="width_meters" value="3">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Depth (meters)</label>
                                    <input type="number" step="0.01" class="form-control" id="depth_meters" name="depth_meters" value="3">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info mt-3" id="size-preview">
                            ...
                            <strong>Total Area:</strong> <span id="total-area">9</span> m² |
                            <strong>Dimensions:</strong> <span id="dimensions-text">3m x 3m</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="base_price" name="base_price" value="0" min="0">
                        </div>

                        <div class="form-group">
                            <label>Deposit Percentage (%)</label>
                            <input type="number" step="0.01" class="form-control" id="deposit_percentage" name="deposit_percentage" value="30" min="0" max="100">
                        </div>

                        <div class="alert alert-secondary mt-3">
                            <small>
                                <strong>Deposit Amount:</strong> SAR <span id="deposit-amount">0</span>
                            </small>
                        </div>
                        ...
                        <a href="<?php echo home_url('/event-manager-dashboard/booth-types'); ?><?php echo $event_id ? '?event_id=' . $event_id : ''; ?>" class="btn btn-secondary btn-block">
